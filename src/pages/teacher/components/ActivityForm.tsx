    ...
    <Card title="Nova atividade">
      <form onSubmit={onSubmit} className="space-y-3 text-sm">
        <label className="block space-y-1">
          <span className="text-stone-600">Título</span>
          <input id="activity-title" className="w-full rounded-lg border border-stone-300 px-3 py-2" />
        </label>
        <label className="block space-y-1">
          <span className="text-stone-600">Tipo</span>
          <select id="activity-type" className="w-full rounded-lg border border-stone-300 px-3 py-2">
            {TYPES.map((t) => (
